...
def test_threat_engine_weapon_hazard():
    engine = ThreatEngine()
    gun_det = Detection(label="gun", confidence=0.95, box=(10, 10, 50, 50), category="weapon")
...
def test_threat_engine_compounding():
    engine = ThreatEngine()
    det1 = Detection(label="gun", confidence=0.9, box=(10, 10, 50, 50), category="weapon")
    det2 = Detection(label="fire", confidence=0.9, box=(60, 60, 100, 100), category="fire")
